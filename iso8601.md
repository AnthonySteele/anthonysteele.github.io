...
For C# code, an ISO8601 Datetime maps most closely to the [`DateTimeOffset` structure](https://msdn.microsoft.com/en-us/library/system.datetimeoffset.aspx). You should stop using `DateTime` and use `DateTimeOffset` almost everywhere.
