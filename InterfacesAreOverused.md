...
When should you extract a function? [Don't Repeat Yourself](https://en.wikipedia.org/wiki/Don%27t_repeat_yourself) is a good rule, but bear in mind that it is a guideline and not an absolute imperative, and needs to be weighed against other concerns. It can have costs as well as benefits, and is most worthwhile when:
